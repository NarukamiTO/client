package platform.client.core.general.pushnotification.impl.model {
  ...
  public class FirebasePushNotificationPanelUserProfileModelBase extends Model {
    ...
    private var client:IFirebasePushNotificationPanelUserProfileModelBase = IFirebasePushNotificationPanelUserProfileModelBase(this);
    private var modelId:Long = Long.getLong(2033956669,-1526848204);
