package com.hurlant.crypto.tests {
  ...
  public class BlowFishKeyTest extends TestCase {
    public function BlowFishKeyTest(param1:ITestHarness) {
      super(param1,"BlowFishKey Test");
      runTest(this.testECB,"BlowFish ECB Test Vectors");
      param1.endTestCase();
    }
