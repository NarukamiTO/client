package com.hurlant.crypto.tests {
  ...
  public class OFBModeTest extends TestCase {
    ...
    public function testOFB_AES128() : void {
      ...
      var local3:ByteArray = Hex.toArray("3b3fd92eb72dad20333449f8e83cfb4a" + "7789508d16918f03f53c52dac54ed825" + "9740051e9c5fecf64344f7a82260edcc" + "304c6528f659c77866a510d9c1d6ae5e");
      var local4:OFBMode = new OFBMode(new AESKey(local1),new NullPad());
      ...
      assert("OFB_AES128 test 1",Hex.fromArray(local5) == Hex.fromArray(local3));
      local4.decrypt(local5);
      assert("OFB_AES128 test 2",Hex.fromArray(local5) == Hex.fromArray(local2));
    }

    public function testOFB_AES192() : void {
      var local1:ByteArray = Hex.toArray("8e73b0f7da0e6452c810f32b809079e562f8ead2522c6b7b");
      var local2:ByteArray = Hex.toArray("6bc1bee22e409f96e93d7e117393172a" + "ae2d8a571e03ac9c9eb76fac45af8e51" + "30c81c46a35ce411e5fbc1191a0a52ef" + "f69f2445df4f9b17ad2b417be66c3710");
      var local3:ByteArray = Hex.toArray("cdc80d6fddf18cab34c25909c99a4174" + "fcc28b8d4c63837c09e81700c1100401" + "8d9a9aeac0f6596f559c6d4daf59a5f2" + "6d9f200857ca6c3e9cac524bd9acc92a");
      var local4:OFBMode = new OFBMode(new AESKey(local1),new NullPad());
      local4.IV = Hex.toArray("000102030405060708090a0b0c0d0e0f");
      var local5:ByteArray = new ByteArray();
      local5.writeBytes(local2);
      local4.encrypt(local5);
      assert("OFB_AES192 test 1",Hex.fromArray(local5) == Hex.fromArray(local3));
      local4.decrypt(local5);
      assert("OFB_AES192 test 2",Hex.fromArray(local5) == Hex.fromArray(local2));
    }
    ...
    public function testOFB_AES256() : void {
      ...
      var local2:ByteArray = Hex.toArray("6bc1bee22e409f96e93d7e117393172a" + "ae2d8a571e03ac9c9eb76fac45af8e51" + "30c81c46a35ce411e5fbc1191a0a52ef" + "f69f2445df4f9b17ad2b417be66c3710");
      var local3:ByteArray = Hex.toArray("dc7e84bfda79164b7ecd8486985d3860" + "4febdc6740d20b3ac88f6ad82a4fb08d" + "71ab47a086e86eedf39d1c5bba97c408" + "0126141d67f37be8538f5a8be740e484");
      var local4:OFBMode = new OFBMode(new AESKey(local1),new NullPad());
      local4.IV = Hex.toArray("000102030405060708090a0b0c0d0e0f");
      var local5:ByteArray = new ByteArray();
      local5.writeBytes(local2);
      local4.encrypt(local5);
      assert("OFB_AES256 test 1",Hex.fromArray(local5) == Hex.fromArray(local3));
      local4.decrypt(local5);
      assert("OFB_AES256 test 2",Hex.fromArray(local5) == Hex.fromArray(local2));
    }
  }
}
