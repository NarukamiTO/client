  ...
  public class TripleDESKey extends DESKey {
    ...
    override public function dispose() : void {
      ...
      if(this.encKey2 != null) {
        local1 = 0;
        while(local1 < this.encKey2.length) {
          this.encKey2[local1] = 0;
          local1++;
        }
        this.encKey2 = null;
      }
      if(this.encKey3 != null) {
        local1 = 0;
        while(local1 < this.encKey3.length) {
          this.encKey3[local1] = 0;
          local1++;
        }
        this.encKey3 = null;
      }
      if(this.decKey2 != null) {
        local1 = 0;
        while(local1 < this.decKey2.length) {
          this.decKey2[local1] = 0;
          local1++;
        }
        this.decKey2 = null;
      }
      if(this.decKey3 != null) {
        local1 = 0;
        while(local1 < this.decKey3.length) {
          this.decKey3[local1] = 0;
          local1++;
        }
        this.decKey3 = null;
      }
