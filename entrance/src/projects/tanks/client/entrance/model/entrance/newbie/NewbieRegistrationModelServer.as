package projects.tanks.client.entrance.model.entrance.newbie {
  ...
  public class NewbieRegistrationModelServer {
    ...
    private var _markUserAsNewbieId:Long = Long.getLong(1894624272,1244277548);
    ...
    public function markUserAsNewbie() : void {
      ...
      var local1:SpaceCommand = new SpaceCommand(Model.object.id,this._markUserAsNewbieId,this.protocolBuffer);
