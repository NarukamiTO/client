package projects.tanks.client.entrance.model.entrance.telegram {
  ...
  public class TelegramEntranceModelServer {
    ...
    private var _loginId:Long = Long.getLong(808470229,1758443450);
    private var _login_jsonCodec:ICodec;
    ...
    public function TelegramEntranceModelServer(param1:IModel) {
      ...
      this._login_jsonCodec = this.protocol.getCodec(new TypeCodecInfo(String,false));
    }

    public function login(param1:String) : void {
      ByteArray(this.protocolBuffer.writer).position = 0;
      ByteArray(this.protocolBuffer.writer).length = 0;
      this._login_jsonCodec.encode(this.protocolBuffer,param1);
      ByteArray(this.protocolBuffer.writer).position = 0;
