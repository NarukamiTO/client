package projects.tanks.client.entrance.model.entrance.telegram {
  ...
  public class TelegramEntranceModelBase extends Model {
    ...
    private var client:ITelegramEntranceModelBase = ITelegramEntranceModelBase(this);
    private var modelId:Long = Long.getLong(1128540715,1798214066);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(TelegramEntranceModelCC,false)));
    }
