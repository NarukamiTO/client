package projects.tanks.client.entrance.model.entrance.google {
  ...
  public class GoogleEntranceModelServer {
    private var protocol:IProtocol;
    private var protocolBuffer:ProtocolBuffer;
    private var _loginId:Long = Long.getLong(818424192,1970200198);
    private var _login_idTokenCodec:ICodec;
    private var model:IModel;

    public function GoogleEntranceModelServer(param1:IModel) {
      super();
      this.model = param1;
