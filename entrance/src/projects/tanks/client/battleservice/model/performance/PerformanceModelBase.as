package projects.tanks.client.battleservice.model.performance {
  ...
  public class PerformanceModelBase extends Model {
    ...
    private var client:IPerformanceModelBase = IPerformanceModelBase(this);
    private var modelId:Long = Long.getLong(181133769,676290849);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(PerformanceCC,false)));
    }
