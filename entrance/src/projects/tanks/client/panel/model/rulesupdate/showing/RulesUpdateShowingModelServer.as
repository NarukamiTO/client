package projects.tanks.client.panel.model.rulesupdate.showing {
  ...
  public class RulesUpdateShowingModelServer {
    ...
    private var _userAcceptedRulesId:Long = Long.getLong(1030475044,1810667908);
    ...
    public function userAcceptedRules() : void {
      ...
      var local1:SpaceCommand = new SpaceCommand(Model.object.id,this._userAcceptedRulesId,this.protocolBuffer);
