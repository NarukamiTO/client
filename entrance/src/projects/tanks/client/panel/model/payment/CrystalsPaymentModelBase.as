package projects.tanks.client.panel.model.payment {
  ...
  public class CrystalsPaymentModelBase extends Model {
    ...
    private var client:ICrystalsPaymentModelBase = ICrystalsPaymentModelBase(this);
    private var modelId:Long = Long.getLong(1836258467,-1815527913);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(CrystalsPaymentCC,false)));
    }
