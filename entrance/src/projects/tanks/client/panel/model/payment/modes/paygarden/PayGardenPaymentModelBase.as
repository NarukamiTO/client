package projects.tanks.client.panel.model.payment.modes.paygarden {
  ...
  public class PayGardenPaymentModelBase extends Model {
    ...
    private var client:IPayGardenPaymentModelBase = IPayGardenPaymentModelBase(this);
    private var modelId:Long = Long.getLong(1881983528,123164696);
    private var _receiveUrlId:Long = Long.getLong(849747999,304240905);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(PayGardenPaymentCC,false)));
