package projects.tanks.client.panel.model.bonus.showing.items {
  ...
  public class BonusItemsShowingModelBase extends Model {
    ...
    private var modelId:Long = Long.getLong(1129865011,-1493936044);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(BonusItemsShowingCC,false)));
    }
