package projects.tanks.client.panel.model.shop.indemnity {
  ...
  public class IndemnityModelBase extends Model {
    ...
    private var client:IIndemnityModelBase = IIndemnityModelBase(this);
    private var modelId:Long = Long.getLong(1847639326,476338528);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(IndemnityCC,false)));
    }
