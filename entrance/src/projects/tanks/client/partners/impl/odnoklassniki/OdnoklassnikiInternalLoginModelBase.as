package projects.tanks.client.partners.impl.odnoklassniki {
  ...
  public class OdnoklassnikiInternalLoginModelBase extends Model {
    ...
    private var client:IOdnoklassnikiInternalLoginModelBase = IOdnoklassnikiInternalLoginModelBase(this);
    private var modelId:Long = Long.getLong(1448441006,1809522840);
