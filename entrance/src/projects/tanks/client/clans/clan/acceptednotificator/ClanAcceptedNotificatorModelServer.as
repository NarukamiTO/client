package projects.tanks.client.clans.clan.acceptednotificator {
  ...
  public class ClanAcceptedNotificatorModelServer {
    private var protocol:IProtocol;
    private var protocolBuffer:ProtocolBuffer;
    private var _removeId:Long = Long.getLong(1326953817,583214193);
    private var _remove_userIdCodec:ICodec;
    private var model:IModel;

    public function ClanAcceptedNotificatorModelServer(param1:IModel) {
      super();
      this.model = param1;
