package _codec.projects.tanks.client.garage.models.item.countable {
  ...
  public class CodecCountableItemCC implements ICodec {
    public static var log:IClientLog = IClientLog(OSGi.getInstance().getService(IClientLog));

    private var codec_count:ICodec;

    public function CodecCountableItemCC() {
      super();
    }
    ...
    public function decode(param1:ProtocolBuffer) : Object {
      var local2:CountableItemCC = new CountableItemCC();
    ...
    public function encode(param1:ProtocolBuffer, param2:Object) : void {
      ...
      var local3:CountableItemCC = CountableItemCC(param2);
