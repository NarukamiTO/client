package projects.tanks.client.garage.models.item.itemforpartners {
  ...
  public class ItemEnabledForPartnerModelBase extends Model {
    ...
    private var client:IItemEnabledForPartnerModelBase = IItemEnabledForPartnerModelBase(this);
    private var modelId:Long = Long.getLong(49746997,526537269);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(ItemEnabledForPartnerCC,false)));
    }
