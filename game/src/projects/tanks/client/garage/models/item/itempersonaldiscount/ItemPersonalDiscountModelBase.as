package projects.tanks.client.garage.models.item.itempersonaldiscount {
  ...
  public class ItemPersonalDiscountModelBase extends Model {
    ...
    private var client:IItemPersonalDiscountModelBase = IItemPersonalDiscountModelBase(this);
    private var modelId:Long = Long.getLong(1297980728,-1710036775);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(ItemPersonalDiscountCC,false)));
    }
