package projects.tanks.client.battlefield.models.tankparts.weapons.artillery.sfx {
  ...
  public class ArtillerySfxModelBase extends Model {
    ...
    private var client:IArtillerySfxModelBase = IArtillerySfxModelBase(this);
    private var modelId:Long = Long.getLong(1047583544,1567719516);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(ArtillerySfxCC,false)));
    }
