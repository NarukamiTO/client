package projects.tanks.client.battlefield.models.tankparts.armor.simple {
  ...
  public class SimpleArmorModelBase extends Model {
    ...
    private var client:ISimpleArmorModelBase = ISimpleArmorModelBase(this);
    private var modelId:Long = Long.getLong(1842275960,1015636683);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(SimpleArmorCC,false)));
    }
