package projects.tanks.client.battlefield.models.tankparts.sfx.isis {
  ...
  public class IsisSFXModelBase extends Model {
    ...
    private var client:IIsisSFXModelBase = IIsisSFXModelBase(this);
    ...
    protected function initCodecs() : void {
      ...
      local1.registerModelConstructorCodec(this.modelId,this._protocol.getCodec(new TypeCodecInfo(IsisSFXCC,false)));
    }
