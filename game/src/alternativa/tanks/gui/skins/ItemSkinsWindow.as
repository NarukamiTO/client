package alternativa.tanks.gui.skins {
  ...
  public class ItemSkinsWindow extends DialogWindow {
    ...
    public function ItemSkinsWindow(param1:IGameObject, param2:Function) {
      super();
      this.item = param1;
    ...
    private function addSkinsPanel() : void {
      ...
      var local1:Vector.<IGameObject> = AvailableSkins(this.item.adapt(AvailableSkins)).getSkins();
      var local2:int = 6;
    ...
    private function createSkinDescription(param1:IGameObject, param2:int) : SkinDescription {
      var local3:SkinDescription = new SkinDescription(this.item,param1);
      local3.y = param2;
    ...
    private function updateAll(param1:Event) : void {
      var local2:SkinDescription = null;
    ...
    public function close() : void {
      var local1:SkinDescription = null;
      this.removeEvents();
