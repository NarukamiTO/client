package alternativa.tanks.service.itempropertyparams.aggregationmodes {
  ...
  public class SumUpgradeAggregationMode implements UpgradeAggregationMode {
    [Inject]
    public static var propertyParamsService:ItemPropertyParamsService;

    public function SumUpgradeAggregationMode() {
      super();
    }
    ...
    public function createValueCalculator(param1:int, param2:GaragePropertyParams) : PropertyCalculator {
      ...
      local5 *= local8;
      local6 *= local8;
      return new BasePropertyCalculator(param2.precision,new LinearPropertyValueCalculator(local5,local6,param1));
    }
  }
}
